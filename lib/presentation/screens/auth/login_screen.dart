                  ...
                  children: [
                    ...
                    Center(
                      child: Container(
                        ...
                        child: const Icon(LucideIcons.shieldCheck, color: AppTheme.primaryColor, size: 48),
                      ),
                    ),
                    const SizedBox(height: 32),
                    const Text('Bon retour !', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Color(0xFF0F172A), letterSpacing: -0.5), textAlign: TextAlign.center),
                    const SizedBox(height: 8),
                    const Text('Connectez-vous à votre compte ScanPay', style: TextStyle(fontSize: 14, color: Color(0xFF64748B)), textAlign: TextAlign.center),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          ...
                          child: const Text('Créer un compte', style: TextStyle(color: AppTheme.primaryColor, fontWeight: FontWeight.bold)),
                        ),
                      ],
                    ),
                  ],
